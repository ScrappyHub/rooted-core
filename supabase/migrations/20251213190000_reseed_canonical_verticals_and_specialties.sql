...
-- ROOTED CORE: Canonical reseed to the locked 21 verticals + rebuild 21 defaults
-- IMPORTANT:
--  - canonical_verticals is protected by trigger and only writable during migration bypass
--  - DO NOT touch specialty_vertical_overlays in this migration (overlay writes may be service_role locked)
...
-- 1) Reset defaults mapping table (this was corrupted previously)
...
-- 4) Rebuild vertical_canonical_specialties = exactly 21 rows (1 per vertical)
