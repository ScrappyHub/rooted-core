...
grant select on public.arts_culture_events_discovery_v1     to anon;
grant select on public.arts_culture_providers_discovery_v1  to anon;
grant select on public.community_landmarks_kidsafe_v1       to anon;
grant select on public.community_providers_discovery_v1      to anon;
grant select on public.education_providers_discovery_v1      to anon;
grant select on public.events_discovery_v1                   to anon;
grant select on public.events_public_v1                      to anon;
grant select on public.experiences_discovery_v1              to anon;
grant select on public.landmarks_public_kids_v1              to anon;
grant select on public.landmarks_public_v1                   to anon;
grant select on public.providers_discovery_v1                to anon;
grant select on public.providers_public_v1                   to anon;
